...
const Hero = () => {
  return (
    <section className="bg-neutral-200" id="home" style={{backgroundImage: `url(${hero})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
       <div className={`${section.flexCenter} ${section.padding} sm:items-center justify-center text-center min-h-[100vh] sm:w-4/5 md:w-[70%] m-auto`}>
            ...
            <p className="text-neutral-2">We provide comprehensive web programming, cyber security, IT consulting, and networking services to help your business succeed.</p>
