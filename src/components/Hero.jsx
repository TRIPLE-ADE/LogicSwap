...
const Hero = () => {
  return (
    <section className="bg-neutral-200">
       <div className={`${section.flexCenter} ${section.padding} sm:items-center text-center min-h-[80vh] sm:w-4/5 md:w-[70%] m-auto`}>
            <p className="text-lg font-semibold text-primary">Transforming Ideas into Digital Success</p>
            <h1 className="my-2 text-3xl font-bold sm:text-6xl font-quicksand">Expert IT Solutions for Your Business Needs!</h1>
